...
{
printf("\n\nSintaxe do comando\ncalcula [expressao aritmetica]\n\nNão existe ordem de precedentes definida\nNúmeros podem ser negativados, entretanto expressões não podem...");
}
return 1;
}
...
/*
O Parser aritmético foi programado por terceiros, disponível em 
